...
const InvoiceForm = () => {
  ...
  const handleParseInvoice = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:5000/upload-and-parse", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });

      // Extract the invoice details from the response
      setInvoiceDetails(response.data.invoiceDetails);
      console.log("Extracted Invoice Details:", response.data.invoiceDetails);
    } catch (error) {
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <input
              ...
              className="btn accordion-button mb-3"
              style={{ display: "block", margin: "10 auto", marginBottom: "10px", marginTop: "40px" }}
            />
